...
const AddColumnModal: React.FC<AddColumnModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-30">
      ...
      >
        <h1 className="text-xl font-bold text-blue-900 mb-2">Add New Column</h1>
        ...
        <div className="flex justify-end space-x-4 mt-6">
          ...
          <button
            ...
            className="py-2 px-4 flex items-center justify-center space-x-2 rounded-lg bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50"
          >
            {loading ? (
              <>
                <svg
