...
The extras completed for this project were:
\begin{itemize}
    \item[(a)] A usability testing report. This provides documentation for how
    usability was assessed, the results of the usability testing sessions
    conducted, and the changes proposed and implemented in response to the
    feedback received.
    \item[(b)] A user guide/manual. This provides documentation for users of the
    product on how to use the application and troubleshoot common issues.
\end{itemize}
