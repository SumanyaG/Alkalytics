...
Expected Output: \st{A small written human-readable paragraph explaining the input
data.} A regression analysis that provides a visualization of the data's
...
Actual Output: No issues discovered when using Google Chrome. The experience is same as
the expected.
