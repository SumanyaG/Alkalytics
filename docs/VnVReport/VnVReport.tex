...
Table \ref{UT:UM} provides a summary of the results for each test, where each
test includes a link to its corresponding test file in the project repository.
\begin{table}[H]
  \centering
  \begin{tabular}{|c|c|c|}
    \hline
