...
\begin{itemize}
  ...
  \item Queries executed before disconnection are still accessible and
  functional.
...
%feedback from the Rev 0 demo to the supervisor (or to potential users) should
%be highlighted.}
...
Table \ref{table:modTrace1} provides a traceability matrix for the system test
cases to the modules.
\begin{table}[H]
  \centering
  \centerline{
  \begin{tabular}{|c|c|c|c|c|c|c|c|}
