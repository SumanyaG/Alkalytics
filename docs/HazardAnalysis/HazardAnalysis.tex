...
\begin{enumerate}
    ...
    a team. Since this milestone was due the week after reading week when most of us had >2 midterms along
    with multiple other assignments, it was harder to coordinate times to meet up and get a lot of the work done
    ...
    could be written somewhat independently), it was a lot harder to divide the sections. This ties back to the aforementioned 
    ...
    Our team ahd thought of a majority of the risks before this deliverable. The ones that we had not
    ...
    and tried to consider all the potential ways the component can fail.
