...
\section*{Revision History}
  ...
  25 March 2025 & 1.4 & Updated to adhere to 
...
The following symbolic parameters are used throughout the document:

\begin{itemize}
\item $TIMEOUT\_LIMIT = 60$ (Timeout for processes in seconds)
\end{itemize}
...
\begin{itemize}
  ...
  to use. 
  \item Dr.\ Carly Kelvon is a $TIMEOUT\_LIMIT$ years old professor at a university and
...
\begin{enumerate}
\item[\textbf{PR-1.}] The application shall store new data or parameters within $TIMEOUT\_LIMIT$ seconds of input.
  \begin{itemize}
