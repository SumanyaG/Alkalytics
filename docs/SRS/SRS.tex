...
\begin{enumerate}
  ...
  \begin{itemize}
    ...
    about what the purpose of all buttons without needing to ask questions.
  \end{itemize}
...
\begin{enumerate}
  ...
  \begin{itemize}
    ...
    \item \textit{Fit Criterion:} After a user's first encounter with the product, the user should answer that there are 0 fonts do not belong on the website. 
  \end{itemize}
\end{enumerate}
