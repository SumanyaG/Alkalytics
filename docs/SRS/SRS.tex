...
\textbf{SR-1.} Access to the application must be restricted to
  ...
  \begin{itemize}
    ...
    \item \textit{Traceability:} FR-14, SR-2, SR-4, SR-8, SR-10.
  \end{itemize}
\ \\
...
\textbf{SR-12.} All personal information related to experimental
  ...
  \begin{itemize}
    ...
    \item \textit{Traceability:} SR-13.
  \end{itemize}
\ \\
\textbf{SR-13.} The application must restrict data sharing with external
  ...
  \begin{itemize}
    ...
    sharing.
    \item \textit{Traceability:} FR-14, SR-1, SR-2, SR-12.
  \end{itemize}
...
\textbf{SR-15.} The application must maintain a comprehensive audit
  ...
  \end{itemize}
\ \\
\textbf{SR-16.} Audit logs must be securely stored and accessible only
...
\textbf{SR-18.} The application must have proactive measures to detect
