...
\begin{tabularx}{\textwidth}{p{4cm}p{1.5cm}X} \toprule {\textbf{Date}} &
  ...
  4 April 2025 & 1.8 & Replaced all PNG diagrams with PDF versions to adhere to \href{https://github.com/SumanyaG/Alkalytics/issues/150}{150}. \\
  \bottomrule
\end{tabularx}
...
\begin{figure}[H]
  \centering
  \includegraphics[angle=-90,origin=c,scale=0.5]{Diagrams/Work Context Diagram.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.6]{Diagrams/Business Data Model.pdf}
...
Table \ref{PUCT} shows a Product Use Case (PUC) table, an extension of the use
case diagram shown in Figure \ref{UCD}. The table aims to provide more details.
\begin{table}[H]
  \centering
  \begin{tabular}{|p{0.08\linewidth}|p{0.2\linewidth}|l|p{0.4\linewidth}|}
    \hline
...
A script will be written to automate the translation of files from CSV to JSON format. This has been described in detail in the \nameref{data} section.
