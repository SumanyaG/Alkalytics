...
\begin{enumerate}
  ...
  \begin{itemize}
    ...
    \item The tester must ensure that the upload duration does not exceed 60 seconds
  ...
  \begin{itemize}
    ...
    criteria
    \item Queries must take less than 3 seconds to run, and the page must respond in 2 seconds.
  \end{itemize}
  ...
  \begin{itemize}
    ...
    \item The tester must ensure that the website responds within 1 second
  \end{itemize}
  ...
  \begin{itemize}
    ...
    \item The tester must ensure that the time taken does not exceed 10 seconds
    \end{itemize}
  ...
  How test will be performed:
  \begin{itemize}
    \item A set of parameter/dataset combinations will be used as queries to
    simulate normal functionality of application
    \item The tester throughout the process will ensure that data and parameter
    values are all accurate to 4 decimals, and time stamps will be accurate to
  ...
  Input/Condition: Large suite of dummy test data (approximately 300 experiments worth of data)
