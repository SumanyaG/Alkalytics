...
plans for the
\href{https://github.com/SumanyaG/Alkalytics/blob/main/docs/SRS/SRS.pdf}{SRS},
\href{https://github.com/SumanyaG/Alkalytics/blob/main/docs/Design/MG.pdf}{MG}, the VnV plan itself, and the system
implementation.\\
...
After the completion of the initial draft of the design documentation, the Module
Guide (MG), each member of the testing team will conduct a comprehensive
...
guarantees that all possible user flows involving the main application
...
The tests below provide a way to evaluate the data querying and visualization
...
\begin{enumerate}
  ...
  corresponding to the selected parameters from the input
  ...
  expected output. The output visualization will then be tested for
    ...
    \end{itemize}
      ...
      \end{itemize}
        \begin{enumerate}
          ...
          Test Case Derivation: This is to ensure the efficiency of the querying
...
\item{NFR-SR1 (Authentication)\\}
  ...
  \begin{itemize}
    ...
    access attempts, noting any error messages or behaviour.
...
\noindent For backend testing, each test case in a singular file is named
...
and
\href{https://github.com/SumanyaG/Alkalytics/blob/main/src/frontend/test/components/upload/UploadArea.test.tsx}{UploadArea.test.tsx}.
...
\begin{itemize}
  \item 6.4-UT1: Registers a new user with a valid email and password.
  \item 6.4-UT2: Does not register a user with an existing email.
  \item 6.4-UT3: Validates a user with correct email and password.
  \item 6.4-UT4: Does not validate a user with incorrect password.
  \item 6.5-UT5: Retrieves user data from the database.
  \item 6.5-UT6: Creates user session information in the database.
  \item 6.5-UT7: Removes user session information in the database.
  \item 6.5-UT8: Updates a user's password correctly in the database.
  \item 6.5-UT9: Updates a user's role correctly in the database.
  \item 6.5-UT10: Deletes an existing user account.
  \item 6.5-UT11: Attempt at removal of nonexisting user account does not throw
  an error.
  \item 6.5-UT12: (frontend) Redirects a user with successful logout to the
  login page.
  \item 6.5-UT13: (frontend) Restricts access to pages when the user is not
  logged in.
  \item 6.5-UT14: (frontend) Checks if session token information is present when
  user is logged in.
  \item 6.5-UT15: (frontend) Checks if session token information is removed when
  user is not logged in.
\end{itemize}

\subsection{Traceability Between Test Cases and Modules}
Table \ref{table:modTrace1} shows the traceability between the modules and the
system tests.
