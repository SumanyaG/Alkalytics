...
\renewcommand{\arraystretch}{1.2}\begin{tabular}{l l} 
  ...
  THRESHOLD & Regular threshold standard (80\%)\\
  CRIT\_THRESHOLD & Critical threshold standard (90\%)\\
  \bottomrule
\end{tabular}\\
...
storagee for the following functional requirements:
\begin{itemize}
  \item FR-1
  \item FR-2
  \item FR-3
...
\begin{enumerate}
  ...
  asked for, and the user is allowed to customize the visuallized data.
    ...
    \end{itemize}
      ...
      \end{itemize}
        \begin{enumerate}
          ...
          recorded to document any inconsistancies to increase traceability.
...
\begin{enumerate}
  ...
  \begin{itemize}
    ...
    if the data was transferred correctly, with the symbols
  \end{itemize}
