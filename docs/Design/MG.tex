...
18 January 2025 & 1.2 & Refined the document and added appendix.\\
=======
<<<<<<< HEAD
<<<<<<< HEAD
17 Janury 2025 & 1.1 & Finalized document for Rev 0 submission.\\
<<<<<<< HEAD:docs/Design/SoftArchitecture/MG.tex
=======
...
=======
18 January 2025 & 1.2 & Refined the document and added appendix.\\
>>>>>>> a8521c0 (doc(design): clean up folders, add README):docs/Design/MG.tex
>>>>>>> 7096840 (doc(design): clean up folders, add README)
\bottomrule
\end{tabularx}
\\
\newline \newline
...
This section provides a use hierarchy between modules that have been described in detail 
...
\newline
Figure \ref{FigUH} illustrates the use relations between these modules. It can be seen that 
the graph is a DAG. Each level of the hierarchy offers a testable
